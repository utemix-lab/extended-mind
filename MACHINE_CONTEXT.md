...
## 12. Capability Map (мета-артефакт)

Capability Map = распределение фишек по персонажам и практикам.
Это не канон и не пользовательский контент. Он фиксирует рефлексию этапа.

---

## 13. Быстрый старт для нового кодера
...
Последний checkpoint: `2026-01-emergent-modes.md`
